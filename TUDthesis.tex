...
\begin{figure}[h]
	\centering
	\includegraphics[width=\linewidth]{IDE_VN.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=12cm, height=8cm]{sub_topo.jpg}
